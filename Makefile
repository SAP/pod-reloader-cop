...
CODE_GENERATOR_VERSION ?= v0.30.4
...
update-content: ## Update external resources used by this repository.
	...
	helm fetch oci://ghcr.io/sap/pod-reloader-helm/pod-reloader --untar --untardir pkg/operator/data/charts
