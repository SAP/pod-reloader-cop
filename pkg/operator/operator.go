/*
SPDX-FileCopyrightText: 2026 SAP SE or an SAP affiliate company and pod-reloader-cop contributors
...
const Name = "pod-reloader-cop.cs.sap.com"
...
func (o *Operator) Setup(mgr ctrl.Manager) error {
	...
	if err := component.NewReconciler[*operatorv1alpha1.PodReloader](
		o.options.Name,
		resourceGenerator,
